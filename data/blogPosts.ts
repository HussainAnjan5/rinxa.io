...
export const blogCategories: BlogCategory[] = [
  { id: 'seo', name: 'SEO', color: 'bg-indigo-100 text-indigo-800' },
  { id: 'link-building', name: 'Link Building', color: 'bg-lime-100 text-lime-800' },
  { id: 'content', name: 'Content Strategy', color: 'bg-purple-100 text-purple-800' },
  { id: 'case-study', name: 'Case Study', color: 'bg-blue-100 text-blue-800' },
  { id: 'tips', name: 'Tips & Tricks', color: 'bg-pink-100 text-pink-800' },
];
